...
public class WR_STATS {
    ...
    //Columns
    public static final String PLAYER_ID = "wrpid";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" +
            ...
            " REFERENCES " + WR.TABLE_NAME + "(" + WR.ID + ")" +
            ")";

    public static final String DROP_TABLE = "DROP TABLE IF EXISTS " + TABLE_NAME;

    public WR_STATS(int week, Row data){
    ...
    public WR_STATS(ResultSet resultSet){
        try{
